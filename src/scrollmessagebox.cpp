...
ScrollMessageBox::ScrollMessageBox(QMessageBox::Icon icon, QString const& title,
  ...
  buttonBox = new QDialogButtonBox((QDialogButtonBox::StandardButtons)((uint)buttons),this);
...
QMessageBox::StandardButton ScrollMessageBox::critical(QWidget* parent, QString const& title, QString const& text,
...
QMessageBox::StandardButton ScrollMessageBox::information(QWidget* parent, QString const& title, QString const& text,
                                                          QMessageBox::StandardButtons buttons, QMessageBox::StandardButton defaultButton) {
...
QMessageBox::StandardButton ScrollMessageBox::question(QWidget* parent, QString const& title, QString const& text,
                                                       QMessageBox::StandardButtons buttons, QMessageBox::StandardButton defaultButton) {
...
QMessageBox::StandardButton ScrollMessageBox::warning(QWidget* parent, QString const& title, QString const& text,
                                                      QMessageBox::StandardButtons buttons, QMessageBox::StandardButton defaultButton) {
